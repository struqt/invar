...
{
    const CRC32 = 0xC4B5CF95;

    static public function &CreateFromBytes (& $str)
    {
        $o = new TestServerTimeN2C;
    ...
    public function write (& $str)
    {
        ...
        BinaryWriter::writeInt64($this->time, $str);
        if ($this->hotfix != NULL) {
            BinaryWriter::writeInt08(0x01, $str);
    ...
    public function &toStringXML()
    {
        ...
        $code .= "\n"; $code .= '<!-- '; $code .= 'TestServerTimeN2C'; $code .= '.CRC32: 0x';
    ...
    public function writeXML (& $s, $name)
    {
        ...
        $attrs .= ' '; $attrs .= 'time'; $attrs .= '=';
        $attrs .= '"'; $attrs .= $this->time; $attrs .= '"';
