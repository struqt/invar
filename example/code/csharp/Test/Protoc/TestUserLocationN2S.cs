...
/// 客户端通知服务端.
public sealed class TestUserLocationN2S
: Invar.BinaryDecode
, Invar.BinaryEncode
, Invar.JSONEncode
, Invar.XMLEncode
{
    public const uint CRC32 = 0xEC953457;
    ...
    private Single                    x         = 0.0F; // 坐标X.
    private Single                    y         = 0.0F; // 坐标Y.
    ...
    /// 坐标X.
    [Invar.InvarRule("float", "")]
    public Single GetX() { return this.x; }

    /// 坐标Y.
    [Invar.InvarRule("float", "")]
    public Single GetY() { return this.y; }
    ...
    /// 坐标X.
    [Invar.InvarRule("float", "")]
    public TestUserLocationN2S SetX(Single value) { this.x = value; return this; }

    /// 坐标Y.
    [Invar.InvarRule("float", "")]
    public TestUserLocationN2S SetY(Single value) { this.y = value; return this; }

    /// [AutoAdd] Hotfix.
    [Invar.InvarRule("map<string,string>", "")]
    public TestUserLocationN2S SetHotfix(Dictionary<String,String> value) { this.hotfix = value; return this; }
    ...
    public TestUserLocationN2S Reuse()
    {
        ...
        return this;
    } //TestUserLocationN2S::Reuse()

    public TestUserLocationN2S Copy(TestUserLocationN2S from_)
    {
    ...
    public override String ToString()
    {
        ...
        result.Append(',').Append(' ').Append("y").Append(':');
        result.Append(this.y.ToString());
    ...
    public void WriteJSON(StringBuilder s)
    {
        ...
        if (!String.IsNullOrEmpty(comma)) { s.Append(comma); comma = null; }
        s.Append('"').Append("x").Append('"').Append(':'); comma = ","; s.Append(this.x.ToString());
        if (!String.IsNullOrEmpty(comma)) { s.Append(comma); comma = null; }
        s.Append('"').Append("y").Append('"').Append(':'); comma = ","; s.Append(this.y.ToString());
    ...
    {
        StringBuilder code = new StringBuilder();
        code.Append("-- TestUserLocationN2S.CRC32: 0x");
    ...
    public void WriteLua(StringBuilder s)
    {
        ...
        if (!String.IsNullOrEmpty(comma)) { s.Append(comma); comma = null; }
        s.Append("x").Append('='); comma = ","; s.Append(this.x.ToString());
        if (!String.IsNullOrEmpty(comma)) { s.Append(comma); comma = null; }
        s.Append("y").Append('='); comma = ","; s.Append(this.y.ToString());
        bool hotfixExists = (null != this.hotfix && this.hotfix.Count > 0);
        if (!String.IsNullOrEmpty(comma) && hotfixExists) { s.Append(comma); comma = null; }
        if (hotfixExists) {
            int hotfixSize = (null == this.hotfix ? 0 : this.hotfix.Count);
    ...
    {
        StringBuilder code = new StringBuilder();
        code.Append("<?php ").Append("/* TestUserLocationN2S.CRC32: 0x");
        code.Append(CRC32.ToString("X2")).Append(" */").Append('\n');
        code.Append('\n').Append("return ");
    ...
    public StringBuilder ToStringXML()
    {
        ...
        code.Append('\n').Append("<!-- ").Append("TestUserLocationN2S").Append(".CRC32: 0x");
    ...
    public void WriteXML(StringBuilder s, String name)
    {
        ...
        attrs.Append(' ').Append("y").Append('=').Append('"').Append(this.y.ToString()).Append('"');
