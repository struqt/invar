...
from TestAbcConflict import Test_Abc_Conflict
from TestAbcGender import Gender
from TestAbcInfo import Info
from TestXyzConflict import Test_Xyz_Conflict
try:
...
class InfoX(object):
   ...
   #__slots__
    ...
    def __init__(self):
        self._infos      = []
        self._conflict_x = Test_Xyz_Conflict()
        self._conflict_a = Test_Abc_Conflict()
        self._mConflict  = {}
        self._info2d     = []
        self._info3d     = []
        self._info5d     = []
