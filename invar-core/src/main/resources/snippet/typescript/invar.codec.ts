...
export module InvarCodec {
    ...
    export interface InvarProtoc extends BinaryDecode, BinaryEncode, JSONEncode {
        getProtocId(): InvarTypes.Uint16
        getProtocCRC(): InvarTypes.Uint16
    }

    export interface ProtocNotify extends InvarProtoc {
    }

    export interface ProtocRequest extends InvarProtoc {
    }

    export interface ProtocResponse extends InvarProtoc {
        getProtocError(): InvarTypes.Uint16
